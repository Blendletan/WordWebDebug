...
At the time this plan was written, Word Web is the only live destination that is guaranteed here. SpellSweep is expected to follow, but its final production URL must not be guessed.
...
## Milestone 5 — Add newsletter/email notification signup
...
## Milestone 6 — Promote voluntary support from invisible footer text to a real post-game CTA
...
## Milestone 7 — De-emphasize “Reveal answer”
...
## Milestone 8 — Completion-panel information hierarchy and polish
...
5. **Get notified about new puzzles**.
6. **Support more puzzles**.
...
## Milestone 9 — README/configuration documentation
...
- newsletter configuration point;
...
- Where do I configure the mailing-list form?
...
## Milestone 10 — Final regression and live-site check
...
18. Newsletter configured and unconfigured.
19. Support click.
20. GoatCounter blocked/unavailable.
21. Narrow mobile viewport.
22. Desktop viewport.
